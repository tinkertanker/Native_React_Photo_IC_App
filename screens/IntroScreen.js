  ...
  return (
    <View style={styles.introContainer}>
      ...
      <Text style={styles.text}>
        ...
        facial recognition to help you crop, reframe, edit, resize... basically
        it's magic.
      </Text>
...
export function Page3({ navigation }) {
  return (
    <View style={styles.introContainer}>
      ...
      <Text style={styles.text}>
        If you'd like to use a better camera to take your photo, go ahead. After
        that, you can import the photo into the app and we'll still do our magic
        and give you a perfect IC Photo.
      </Text>
